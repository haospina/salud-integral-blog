...
Bienvenido al espacio colaborativo de Salud Integral. Aquí puedes:

## 📝 **Cómo Publicar un Artículo**

### 1. **Tipos de Contenido que Puedes Publicar:**

- **Revisiones de Tema**: Síntesis actualizada sobre un tema específico
- **Casos Clínicos**: Presentación de casos con enfoque integrador
- **Reflexiones Clínicas**: Experiencias de práctica con análisis
- **Proyectos de Investigación**: Anteproyectos y protocolos
- **Recursos Educativos**: Resúmenes, diagramas, algoritmos
...
¿Puedo publicar trabajos en grupo?
Sí, se fomenta el trabajo colaborativo.

¿Hay límite de publicaciones por estudiante?
